...
demo = {
  ...
  var minhasLabels = []
    ...
    var mensal = ['JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN', 'JUL', 'AUG', 'SEP', 'OCT', 'NOV', 'DEC']
    ...
    var dataMensal = [050,30,60,40,80,20,60,70,40,20,10,40]
    ...
    var ctx = document.getElementById("chartLineRam").getContext("2d");
...
// =======
    //  var gradientStroke = ctx.createLinearGradient(0, 230, 0, 50);
// >>>>>>> 749e7bf8384576f69c35427b3cadfaae95663613
